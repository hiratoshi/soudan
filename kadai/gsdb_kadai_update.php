...
//３．データ登録SQL作成
$stmt = $pdo->prepare("UPDATE gs_gsdb_table SET school_num=:school_num, picture=:picture, name=:name, select_course=:select_course, age=:age, about_work=:about_work, info=:info, presen=:presen, plan=:plan, datetime=sysdate() WHERE school_num=:school_num");
